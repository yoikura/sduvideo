...
import {getAttention, getAttentionTo} from '../api/api'
export default {
  name: 'UserList',
  components: {
    HeadPicture
  ...
  methods: {
    ...
    getAttention(){
      let res = getAttention({uid:this.uid})
      this.attentionList = res.data.data
    },
    getAttentionTo(){
      console.log("asdasdasd")
      let res = getAttentionTo({uid:this.uid})
      ...
      <div class="userlist-fold">
        ...
        <el-menu :default-active="activeMenu"
          ...
          <el-menu-item index="fans">
            ...
            <span slot="title">全部粉丝<span class="menu-num">{{fanList.length}}</span></span>
          </el-menu-item>
        </el-menu>
      </div>
      <div class="user-list">
            ...
            <div v-if="hasAtData">
              <div class="user-row"
                ...
                <div class="info-div">
                  ...
                  <div class="manifesto">{{attentionList[(curAtPage-1)*10+idx-1].signature}}</div>
                </div>
            ...
            <div v-if="hasFanData">
              <div class="user-row"
                ...
                <div class="info-div">
                  ...
                  <div class="manifesto">{{fanList[(curFanPage-1)*10+idx-1].signature}}</div>
                </div>
                <div class="button-div">
                  <el-button>关注</el-button>
                </div>
