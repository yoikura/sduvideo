  ...
  <div class="event-card">
    <div class="user-info">
      ...
      <div class="user-right">
        <div class="nick-name common-a">{{event.author}}</div>
        <div class="date">{{event.createTime}}</div>
      </div>
...
<!--      </el-dropdown>-->
    ...
    <div class="event-talk">{{event.description}}</div>
    <div class="content">

<!--      <div class="other-user-info"-->
<!--           v-if="event.type===2">-->
<!--        <div class="other-user-left">-->
<!--          &lt;!&ndash; <el-avatar :src="event.work.author.headPicture"-->
<!--                     :size="24"></el-avatar> &ndash;&gt;-->
...
<!--      </div>-->
      <div class="work">
        ...
        <div>
          <div class="work-title">{{event.name}}</div>
          <div class="work-info">
            <span class="icon-i">
              <i class="fa fa-play-circle"></i>{{handleNum(event.playNum)}}
            </span>
            <span style="margin-left:20px;"
                  class="icon-i">
              <i class="fa fa-commenting-o"></i>{{handleNum(event.commentNum)}}
            </span>
            <span style="margin-left:20px;"
                  class="icon-i">
              <i class="fa fa-thumbs-up"></i>{{handleNum(event.likeNum)}}
            </span>
          </div>
        </div>
      </div>
