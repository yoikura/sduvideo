...
import {getUserInfo, getUserWork} from '../api/api'
export default {
  name: 'PSWork',
  components: {
    WorkCard
    ...
    return {
      ...
      workList: [
        { foldName: '默认作品夹',
          ...
          works: [
            { img: require('../assets/img/red.png'), title: '我的视频1', createTime: '20231101101010', watch: 100, collect: 1, like: 1, coin: 1, download: 1 },
            { img: require('../assets/img/red.png'), title: '我的视频2', createTime: '20231102101010', watch: 200, collect: 2, like: 2, coin: 2, download: 2 },
            { img: require('../assets/img/red.png'), title: '我的视频3', createTime: '20181103101010', watch: 300, collect: 3, like: 3, coin: 3, download: 3 },
            { img: require('../assets/img/red.png'), title: '我的视频4', createTime: '20181104101010', watch: 400, collect: 4, like: 4, coin: 4, download: 4 },
            { img: require('../assets/img/red.png'), title: '我的视频5', createTime: '20181105101010', watch: 233, collect: 2, like: 5, coin: 5, download: 5 }
  ...
  methods: {
    ...
    sortWorks (tab, event) {
      ...
      if (tab.name === 'lastUp') {
        ...
        works.sort((a, b) => {
          return b.favoriteNum - a.favoriteNum
        })
      } else {
        works.sort((a, b) => {
          return b.likeNum - b.likeNum
        })
      }
    ...
    async getWorks(){
      let res = await getUserWork({uid: this.$route.query.uid})
      this.workList[0].works = res.data.data
    },
    async getCurrentUserInfo(){
      let res = await getUserInfo({uid: this.$route.query.uid})
      this.currentUser = res.data.data
    },
  },
  async created () {
    this.currentUser = this.$store.state._user.Info
